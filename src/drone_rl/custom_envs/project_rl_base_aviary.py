"""Local project RL base aviary environment.

Initial version copied from: gym_pybullet_drones.envs.BaseRLAviary
Source tree: gym-pybullet-drones/gym_pybullet_drones/envs/BaseRLAviary.py

This local copy is maintained in-project so we can tune RL environment
behavior without editing the upstream package directly.
"""
...
class ProjectBaseRLAviary(ProjectBaseAviary):
