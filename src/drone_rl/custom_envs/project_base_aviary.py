"""Local project base aviary environment.

Initial version copied from: gym_pybullet_drones.envs.BaseAviary
Source tree: gym-pybullet-drones/gym_pybullet_drones/envs/BaseAviary.py

This local copy is maintained in-project so we can tune environment behavior
...
class ProjectBaseAviary(gym.Env):
